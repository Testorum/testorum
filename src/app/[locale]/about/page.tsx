  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      {isKo ? (
        ...
        <>
          <p className="text-gray-600 leading-relaxed mb-4">
            Testorum is a platform offering fun psychology tests on topics like love, personality, and relationships.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            All tests are created for entertainment purposes and are not scientific psychological diagnostic tools.
          </p>
        </>
      )}
